...
/* this code is in ROM - generate long jumps as needed */
#define CODE_IN_ROM __attribute__ ((section (".text"), long_call))
/* Use this data in EWRAM (256k bank) */
...
#define WAITSYNC(X) while (nFrame<(X)); nFrame=0;

// Video tables
#define BG_PALETTE  ((u16*)0x5000000)
#define SPR_PALETTE ((u16*)0x5000200)
...
#define REG_BG0_HSCROLL   *(volatile s16*)0x4000010
#define REG_BG0_VSCROLL   *(volatile s16*)0x4000012
#define REG_BG1_HSCROLL   *(volatile s16*)0x4000014
#define REG_BG1_VSCROLL   *(volatile s16*)0x4000016
#define REG_BG2_HSCROLL   *(volatile s16*)0x4000018
#define REG_BG2_VSCROLL   *(volatile s16*)0x400001A
#define REG_BG3_HSCROLL   *(volatile s16*)0x400001C
#define REG_BG3_VSCROLL   *(volatile s16*)0x400001E

// Video Effects
#define REG_MOSAIC          *(volatile u16*)0x400004C     // TODO: maybe this is 32-bit?
...
#define REG_KEYCNT          *(volatile u32*)0x4000132
...
#define BTN_INT_A               0x0001
#define BTN_INT_B               0x0002
#define BTN_INT_SELECT          0x0004
#define BTN_INT_START           0x0008
#define BTN_INT_RIGHT           0x0010
#define BTN_INT_LEFT            0x0020
#define BTN_INT_UP              0x0040
#define BTN_INT_DOWN            0x0080
#define BTN_INT_R               0x0100
#define BTN_INT_L               0x0200
...
#define fastcopy16(pDest, pSrc, nCount) {   \
    REG_DMA3SAD=(u32)(pSrc);                \
    REG_DMA3DAD=(u32)(pDest);               \
    REG_DMA3CNT_L=(nCount)>>1;              \
    REG_DMA3CNT_H=HALF_WORD_DMA|ENABLE_DMA|START_IMMEDIATELY;   \
}

#define fastcopy(pDest, pSrc, nCount) {     \
    REG_DMA3SAD=(u32)(pSrc);                \
    REG_DMA3DAD=(u32)(pDest);               \
    REG_DMA3CNT_L=(nCount)>>2;              \
    REG_DMA3CNT_H=WORD_DMA|ENABLE_DMA|START_IMMEDIATELY;    \
}

#define fastset(pDest, value, nCount) {     \
    u32 dummy=(value);                      \
